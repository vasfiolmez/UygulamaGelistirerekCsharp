...
namespace Proje_Hastane
{
    public partial class frmDoktorPaneli : Form
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("insert into Tbl_Doktorlar (DoktorAd,SoktorSoyad,DoktorBrans,DoktorTC,DoktorSifre) values (@d1,@d2,@d3,@d4,@d5)");
            ...
            cmd.Parameters.AddWithValue("@d4",msbTC.Text);
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@p1",msbTC.Text);
            cmd.ExecuteNonQuery();
            bgl.baglanti().Close();
